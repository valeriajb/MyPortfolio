...
export function useDatePorfolio(){
    const [datePortfolio,setDatePorfolio]=useState([])
    return({featuredPortfolio,webPortfolio,mobilePortfolio,designPortfolio,contentPortfolio,datePortfolio,setDatePorfolio})
}
